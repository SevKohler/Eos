...
public class EhrService {
    ...
    private NativeQuery<Record2<String, Composition>> buildCompositionQueryEhr(long offset, List<EHRToPerson> ehrToPersonList) {
        ...
        return Query.buildNativeQuery("SELECT e/ehr_id/value, c from EHR e CONTAINS Composition c WHERE " + whereStatements + " ORDER BY e/ehr_id/value DESC, c/context/start_time DESC" + " LIMIT " + offsetLimit + " OFFSET " + offset, String.class, Composition.class);
    }
